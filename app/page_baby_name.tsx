                 ...
                 <div className="grid grid-cols-2 sm:grid-cols-3 gap-4">
                    {generatedNames.map((name, i) => (
                       <button 
                         ...
                         className={`p-6 rounded-xl border text-center transition-all duration-300 flex flex-col items-center justify-center gap-3 group relative shadow-sm hover:shadow-md ${
